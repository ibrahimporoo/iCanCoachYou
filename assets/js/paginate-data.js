...
function filterResults() {
	...
	const filteredData = coaches.filter(coach => {
		...
		if(userCountry == 'Egypt') {
			...
			theCoachPrice = parseInt(coach.pricing_outside_egypt) || 30;
		}
		// theCoachPrice = parseInt(coach.pricing_in_egypt) || parseInt(coach.pricing);
...
/* This Function we use when the coach location is in another land except egypt */
